...
<head>
    ...
    <title>{{ config('app.name', 'Mk Production') }}</title>
            ...
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <div class="d-flex">
                        ...
                        <div class="pl-3 ml-3 pt-2" style="border-left:1px solid rgba(0, 0, 0, 0.5); font-size:1.5rem;"><!-- {{ config('app.name', 'Mk Production') }} -->MK Production</div>
                    </div>
                </a>
            ...
            <div class='container p-0 pt-3'>
                <div class='row'>
                    <div class='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center'>
                        ...
                        <p>MK PRODUCTION <br> Karim & Lala <br> 9594835455 <br> http://mkproducts.epizy.com/</p>
                        <a href='http://mkproducts.epizy.com/' target='_blank'></a></li>
                    </div>
                    <div class='col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12 text-center'>
                        <h3>Follow Us On</h3>
                        <ul>
                    ...
                    <div class='col-md-6 col-sm-12 copyright'>
                        <p>Designed from scratch by Abdulkarim's Group</p>
                        <p>mkproduct &copy; 2020. All Rights Reserved</p>
                    </div>
